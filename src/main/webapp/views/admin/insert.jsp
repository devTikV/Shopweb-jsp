			...
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a class="nav-link text-white "
					href="${pageContext.request.contextPath}/admin/quanlyloaigiay.html">
						...
						</div> <span class="nav-link-text ms-1">Quản lý hãng sản phẩm</span>
				</a></li>
				<li class="nav-item"><a class="nav-link text-white "
  ...
  <path
		...
		<div class="container-fluid py-4">
			...
			<form method="post" style="width: 600px; margin: auto;"
				...
				<div class="form-group">
					<label>Tên sản phẩm</label> <input name="tenGiay" type="text"
						class="form-control"
						style="border: inset rgb(112, 112, 112); width: 500px; padding: 10px;">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label>Loại sản phẩm</label> <select name="maLoaiGiay"
						class="form-control"
						style="border: inset rgb(112, 112, 112); width: 500px; padding: 10px;">
				...
				<div class="form-group">
					<label>Hãng sản phẩm</label> <select name="maHangGiay"
						class="form-control"
						style="border: inset rgb(112, 112, 112); width: 500px; padding: 10px;">
